  ...
  // allow localhost / 127.0.0.1 / LAN (192.168.x.x, 10.x.x.x, 172.16-31.x.x) on any port
  // This enables local network access for development
  const devOriginRegex = /^https?:\/\/(localhost|127\.0\.0\.1|192\.168\.\d+\.\d+|10\.\d+\.\d+\.\d+|172\.(1[6-9]|2[0-9]|3[01])\.\d+\.\d+)(:\d+)?$/;
