...
const fetchRepository = useCallback(async () => {
  try {
    ...
    // Filter by visibility if selected (excluding private for faculty)
            ...
            <View style={styles.dropdownContainer}>
              <View style={styles.dropdownContent}>
                ...
                <ScrollView style={styles.dropdownBody} showsVerticalScrollIndicator={false}>
                  ...
                  {/* Visibility - Only public and campus for faculty */}
                  <View style={styles.filterSection}>
              ...
              {repository.map((r) => {
                ...
                return (
                  <View key={r._id || r.id} style={styles.researchCard}>
                    ...
                    {/* Categories - styled like keywords with different color */}
                    ...
                    {/* Genre Tags - styled like keywords with different color */}
...
const styles = StyleSheet.create({
  ...
  // Category Tags - Blue/Primary color
  categoryTag: {
    paddingHorizontal: 8,
    paddingVertical: 4,
    borderRadius: 999,
  ...
  // Genre Tags - Purple/Secondary color
  genreTag: {
    paddingHorizontal: 8,
    paddingVertical: 4,
    borderRadius: 999,
